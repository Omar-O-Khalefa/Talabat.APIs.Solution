...
namespace Talabat.Infrastructure.Identity.Migrations
{
    ...
    [Migration("20240426230043_IdentityInitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Talabat.Core.Entities.Identity.Adress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talabat.Core.Entities.Identity.Adress", b =>
                {
                    b.HasOne("Talabat.Core.Entities.Identity.AppUser", "User")
                        .WithOne("Adress")
                        .HasForeignKey("Talabat.Core.Entities.Identity.Adress", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
